...
import { BarChart3, Home, SquarePlus } from "lucide-react";
...
export default function BottomNav() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 left-1/2 z-40 grid w-full max-w-[430px] -translate-x-1/2 grid-cols-3 border-t-2 border-divider bg-surface pb-[env(safe-area-inset-bottom)]">
