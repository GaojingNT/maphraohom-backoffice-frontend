...
export default async function ExportSummaryPage({
  ...
  const productMap = new Map<
    string,
    { unit: string; qty: number; value: number }
  >();
                    ...
                    {receiptAgg.count > 0 && (
                      <div className="w-[340px]">
                        <div className="text-[9.5px] font-bold text-accent uppercase">
                          {BILL_TYPE_CONFIG.receipt.title} · {receiptAgg.count}{" "}
                          บิล
                        </div>
                    ...
                    {paymentAgg.count > 0 && (
                      <div className="w-[340px]">
                        <div className="text-[9.5px] font-bold text-payment uppercase">
                          {BILL_TYPE_CONFIG.payment.title} · {paymentAgg.count}{" "}
                          บิล
                        </div>
                    ...
                    {hasMixedTypes && (
                      <div className="flex w-[340px] items-baseline justify-between gap-4 bg-ink px-2.5 py-3 text-white">
                        ...
                        <span className="font-num text-[19px] font-bold">
                          {formatBaht(
                            receiptAgg.grandTotal - paymentAgg.grandTotal,
                          )}
                        </span>
                      </div>
                    )}
...
function TotalsBlock({
  ...
  return (
    <div className="mt-1.5">
      ...
      <div
        className={`mt-2 flex items-baseline justify-between gap-4 px-2.5 py-3 text-white ${colorClass}`}
      >
