  ...
  const receipts = bills.map((b) => {
    ...
    return {
      ...
      totals: [
        ...
        {
          label: "ค่าจัดส่ง",
          value: toNumber(b.shippingFee)
            ? `+ ${formatBaht(b.shippingFee)}`
            : "฿0",
        },
      ],
    ...
    <div className="min-h-dvh bg-[#3d423e]">
      <style>{`
        @media print {
          ...
          .print-scale-outer { height: auto !important; }
          .print-scale-inner { transform: none !important; }
        }
      `}</style>
      <ReceiptPrintToolbar
        title={toolbarTitle}
              ...
              receipts.map((rc) => (
                ...
                >
                  ...
                  <div className="box-border flex flex-1 flex-col px-[44px] pt-[22px] pb-[40px]">
                    ...
                    to co-sign a printed receipt/voucher. One centered stack:
                    the signed-in user's signature, their full name, then the
                    role label. No image → blank space for a physical
                    signature; no name → the label moves up. */}
                    <div className="mt-[22px] flex justify-end">
                      <div className="flex flex-col items-center text-center">
                        ...
                        <div className="mt-[3px] text-[9px] leading-[1.4] text-[#4a544d]">
